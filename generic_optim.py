...
class OcelotInterfaceWindow(QFrame):
    ...
    def __init__(self):
        ...
        hypfilepath = os.path.join(os.getcwd(), "parameters", "hyperparameters.npy")
        print('GENERIC-->Grabbing hyps from...: ', hypfilepath)
        self.hyper_file = hypfilepath
    ...
    def start_scan(self):
        ...
        self.update_plot_timer.start(500)
